...
public class AudioFeatures {
	public static String BOILING = "0";
	public static String MICRO_DONE = "1";
	public static String MICRO_EXPL = "2";
	public static String NO_EVENT = "3";
	...
	static
	{
		...
		attrValues.add(BOILING);
		attrValues.add(MICRO_DONE);
		attrValues.add(MICRO_EXPL);
		attrValues.add(NO_EVENT);
		ClassFeature = new Attribute("Kitchen Event", attrValues);
	}
}